# Item Preview Auto Spinning

Automatically spins the inventory item preview.
...
```
git clone --recurse-submodules -j8 https://github.com/gabriel-andreescu/ItemPreviewAutoSpinning.git
cd ItemPreviewAutoSpinning
